...
public class BaseControllerTest extends BaseSpringTest {
	...
	{
		// token 令牌
		token = "1eb5e2de43f547d5b248ba0107f63958";
		token = "baf8a94b56b347e5a60b4abc5b011246";
		//token = null;
		...
		requestBuilder.header("APP-ID", "100002");
		requestBuilder.header("X-AUTH-HEADER", "ADFDASFASDFASDFASDFADSF");		
